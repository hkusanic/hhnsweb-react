...
export class LatestLecture extends React.Component {
	constructor (props) {
		super(props);
		this.state = {};
	}
				...
				<section className="section section-lg text-center">
					<div className="container">
						<h3 className="wow-outer text-center">
							<span className="wow slideInDown">Latest Lectures</span>
						</h3>
							...
							<div className="col-md-6 wow-outer">
								<article className="post-modern wow fadeInUpSmall">
									...
									<h4 className="post-modern-title">
										<a>How to Plan Your Vacation in Advance</a>
									</h4>
									...
									<p>
										There are different types of travelers but all of them often
										ask us about proper travel planning. In this post, we
										decided to gather tips from our staff and famous travelers
								...
								<article className="post-modern wow fadeInUpSmall">
									...
									<h4 className="post-modern-title">
										<a href="single-blog-post.html">
											Your Personal Guide to 5 Best Places
										</a>
									</h4>
									<ul className="post-modern-meta">
										<li>by Theresa Barnes</li>
									...
									<p>
										Popular destinations change from year to year and what was
										trending in 2017 isn’t so interesting now. However, we have
										picked 5 best places worth visiting where most travelers
										haven’t been yet...
									</p>
								</article>
							</div>
						...
						<div className="wow-outer button-outer">
							<a
								className="button button-primary-outline button-winona wow slideInUp"
								href="grid-blog.html"
							>
								View all Lecture
							</a>
