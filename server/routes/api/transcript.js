...
var Transcript = keystone.list("Transcript");
...
// 		}
// 		ifexports.list = function(req, res) {
// 	// Querying the data this works similarly to the Mongo db.collection.find() method
// 	let query = [];
